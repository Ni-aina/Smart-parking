...
export const normalizeConversation = (conversation: Record<string, unknown>): ConversationInterface => {
    return normalizeData(conversation) as ConversationInterface
}

export const normalizeMessage = (message: Record<string, unknown>): MessageInterface => {
    return normalizeData(message) as MessageInterface
}
